...
namespace Eurekabank_Cliente_Consola_Unificado.Services
{
    ...
    {
        public const string IpServidorSOAP = "localhost";
    }
    /// <summary>
...
<soap:Envelope xmlns:soap=""http://schemas.xmlsoap.org/soap/envelope/"" xmlns:tem=""http://tempuri.org/"">
    ...
    public class SoapJavaService : IEurekabankService
    {
        ...
        //public SoapJavaService(string baseUrl = "http://10.40.20.70:8080/Eurobank_Soap_Java/EurekabankWS")
        public SoapJavaService(string baseUrl = $"http://{GlobalConfigSOAP.IpServidorSOAP}:8080/Eurobank_Soap_Java/EurekabankWS")
        {
            _baseUrl = baseUrl;
            _httpClient = new HttpClient();
            _httpClient.Timeout = TimeSpan.FromSeconds(30);
