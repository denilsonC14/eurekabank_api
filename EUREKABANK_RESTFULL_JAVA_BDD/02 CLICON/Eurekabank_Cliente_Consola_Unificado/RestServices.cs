...
namespace Eurekabank_Cliente_Consola_Unificado.Services
{
    ...
    {
        public const string IpServidorREST = "10.40.18.123";
    }
    /// <summary>
    ...
    public class RestJavaService : IEurekabankService
    {
        ...
        public RestJavaService(string baseUrl = $"http://{GlobalConfigREST.IpServidorREST}:8080/Eurobank_Restfull_Java/api")
        {
            _baseUrl = baseUrl;
            _httpClient = new HttpClient();
            _httpClient.Timeout = TimeSpan.FromSeconds(30);
